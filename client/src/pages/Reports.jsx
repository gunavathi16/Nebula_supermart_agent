      ...
      <main className="flex-1 p-4 sm:p-6 lg:p-8 space-y-5 max-w-7xl mx-auto w-full">
        ...
        <div className="bg-white p-4 rounded-2xl border border-[#E2E8F0] shadow-xs flex flex-wrap items-center justify-between gap-4">
          <div className="flex items-center space-x-2 text-xs font-bold">
            <span className="text-[#64748B]">Analysis Timeframe:</span>
            {[
          ...
          <div className="flex items-center space-x-2">
            <a
              ...
              download
              className="px-3 py-2 bg-[#F0FDF4] hover:bg-[#DCFCE7] text-[#15803D] font-bold text-xs rounded-xl border border-[#E2E8F0] flex items-center space-x-1.5 shadow-xs transition"
            >
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
          <div className="bg-white p-5 rounded-2xl border border-[#E2E8F0] shadow-xs">
            ...
            <p className="text-xs text-[#64748B] mt-1">Catalog items tracked</p>
          </div>
          ...
          <div className="bg-white p-5 rounded-2xl border border-[#E2E8F0] shadow-xs">
            ...
            <p className="text-xs text-[#64748B] mt-1">Total wholesale capital tied in inventory</p>
          </div>
          ...
          <div className="bg-white p-5 rounded-2xl border border-[#E2E8F0] shadow-xs">
            ...
            <p className="text-xs text-[#64748B] mt-1">Potential retail sales realization</p>
          </div>
          ...
          <div className="bg-white p-5 rounded-2xl border border-[#E2E8F0] shadow-xs">
            <div className="flex items-center justify-between mb-2">
              ...
              <span className="text-xs font-bold text-[#15803D] bg-[#F0FDF4] px-1.5 py-0.5 rounded border border-[#E2E8F0]">
            ...
            <p className="text-xs text-[#64748B] mt-1">Expected gross trading profit</p>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-5">
          ...
          <div className="bg-white p-5 rounded-2xl border border-[#E2E8F0] shadow-xs">
            <h3 className="font-bold text-[#0F172A] text-sm mb-1">Sales Velocity Trend</h3>
            <p className="text-xs text-[#64748B] mb-4">Gross counter revenue timeline</p>
          ...
          <div className="bg-white p-5 rounded-2xl border border-[#E2E8F0] shadow-xs">
            <h3 className="font-bold text-[#0F172A] text-sm mb-1">Top Selling SKUs</h3>
            <p className="text-xs text-[#64748B] mb-4">Ranked by revenue contribution</p>
              ...
              <div className="h-64">
                <ResponsiveContainer width="100%" height="100%">
                  <BarChart data={topProducts.slice(0, 6)} layout="vertical">
                    ...
                    />
                    <Bar dataKey="total_revenue" fill="#15803D" radius={[0, 6, 6, 0]} />
                  </BarChart>
                </ResponsiveContainer>
              </div>
            )}
        ...
        <div className="bg-white rounded-2xl border border-[#E2E8F0] shadow-xs overflow-hidden">
          <div className="p-4 border-b border-[#E2E8F0] flex items-center justify-between">
            ...
            <span className="text-[11px] font-bold text-[#15803D] bg-[#F0FDF4] px-2.5 py-1 rounded-lg border border-[#E2E8F0]">
            ...
            <table className="w-full text-left text-xs">
              ...
              <tbody className="divide-y divide-[#E2E8F0]">
                {gstBreakup.length === 0 ? (
                  ...
                  gstBreakup.map((row) => (
                    <tr key={row.gst_slab} className="hover:bg-[#F8FAFC] transition">
                      <td className="py-3 px-4 font-bold text-[#0F172A]">{row.gst_slab}% Slab</td>
